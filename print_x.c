...
void myprintf_x(va_list *list_printf, t_prtf *structprtf)
{
	...
	if (structprtf->zero == 1 && structprtf->width == 0 && structprtf->precisionfound == 0)
		write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
	...
	{
		if (structprtf->width <= ft_strlen(ft_itoa_base(nb, 16, 0)))
			write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
		else
		{
			...
			{
				write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
				print_recursiv(' ', ((structprtf->width) - ft_strlen(ft_itoa_base(nb, 16, 0))));
			}
			else
			{
				print_recursiv(' ', ((structprtf->width) - ft_strlen(ft_itoa_base(nb, 16, 0))));
	...
	{
		if (structprtf->precision <= ft_strlen(ft_itoa_base(nb, 16, 0)))
			write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
		else
		{
			print_recursiv('0', ((structprtf->precision) - ft_strlen(ft_itoa_base(nb, 16, 0))));
			write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
		}
	}
	...
	if (structprtf->precisionfound == 0 && structprtf->width != 0 && structprtf->minus == 0 && structprtf->zero == 1)
	{
		...
		{
			print_recursiv('0', ((structprtf->width) - ft_strlen(ft_itoa_base(nb, 16, 0))));
			write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
		}
	}
	...
	{
		if ((structprtf->width <= ft_strlen(ft_itoa_base(nb, 16, 0))) && (structprtf->precision <= ft_strlen(ft_itoa_base(nb, 16, 0))))
			write(1, ft_itoa_base(nb, 16, 0), ft_strlen(ft_itoa_base(nb, 16, 0)));
		if ((structprtf->width > ft_strlen(ft_itoa_base(nb, 16, 0))) && (structprtf->precision <= ft_strlen(ft_itoa_base(nb, 16, 0))))
		{
			if (structprtf->minus == 1)
